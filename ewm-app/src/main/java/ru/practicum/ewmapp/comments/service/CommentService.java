...
public interface CommentService {
    ...
    List<CommentShortDto> findAllCommentsForUser(Long userId, Long event, CommentState commentState,
    ...
    List<CommentFullDto> findAllCommentsForAdmin(Long eventId, List<Long> userIds, UserState userState,
