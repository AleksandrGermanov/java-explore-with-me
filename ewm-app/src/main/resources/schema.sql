...
category_id BIGINT NOT NULL UNIQUE REFERENCES categories(id) ON DELETE RESTRICT,
confirmed_requests BIGINT,
created_on TIMESTAMP NOT NULL,
description VARCHAR(512),
event_date TIMESTAMP NOT NULL,
initiator_id BIGINT BIGINT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
...
event_id BIGINT NOT NULL REFERENCES events(id) ON DELETE CASCADE,
requester_id BIGINT NOT REFERENCES users(id) ON DELETE CASCADE,
